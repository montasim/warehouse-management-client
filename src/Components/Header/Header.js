...
const Header = () => {
        ...
        <div className="bg-gray-800 font-sans leading-normal tracking-normal" data-new-gr-c-s-check-loaded="14.1058.0" data-gr-ext-installed="">
            ...
            <nav className="flex items-center justify-between flex-wrap bg-gray-100 px-8 py-5 fixed w-full z-10 top-0">
                ...
                <div className="block lg:hidden">
                    ...
                    }} id="nav-toggle" className="flex items-center px-3 py-2 border rounded text-gray-800 border-gray-800 hover:text-orange-500 hover:border-orange-500">
  ...
  " aria-labelledby="dropdownMenuButton2">
      ...
      " to="#">
                                ...
                                <>
                                    <li className="m-3">
                                        <Link className="nav-link text-gray-500 hover:bg-blue-200 hover:px-4 hover:py-1.5 hover:rounded-full hover:text-gray-700 focus:text-gray-700 p-0 flex items-center" to="/register">
