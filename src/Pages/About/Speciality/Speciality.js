...
const Speciality = () => {
    return (
        <aside class="text-white bg-gray-900 pt-20">
            <div class="max-w-screen-xl px-4 py-16 mx-auto sm:px-6 lg:px-8">
                ...
                <div class="mt-12 text-center">
                    <a
                        class="inline-flex items-center px-8 py-3 mt-8 text-white bg-indigo-600 border border-indigo-600 rounded hover:bg-transparent active:text-indigo-500 focus:outline-none focus:ring"
                        href="https://www.linkedin.com/in/montasim"
                    >
                        <span class="text-sm font-medium"> Hire Me </span>
